...
export const getCourseById = async (id: number): Promise<(Course & { lessons: Lesson[] }) | null> => {
...
// Cập nhật khóa học
export const updateCourse = async (id: number, data: Partial<CourseDTO>): Promise<Course> => {
  // Kiểm tra tồn tại
